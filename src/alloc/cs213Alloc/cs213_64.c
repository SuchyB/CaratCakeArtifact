...
#define GET(p)       (*(uint64_t *)(p))            //line:vm:mm:get
...
#define HDRP(bp)       ((int *)(bp) - WSIZE)                      //line:vm:mm:hdrp
#define FTRP(bp)       ((int *)(bp) + GET_SIZE(HDRP(bp)) - DSIZE) //line:vm:mm:ftrp

/* Given block ptr bp, compute address of next and previous blocks */
#define NEXT_BLKP(bp)  ((int *)(bp) + GET_SIZE(((int *)(bp) - WSIZE))) //line:vm:mm:nextblkp
#define PREV_BLKP(bp)  ((int *)(bp) - GET_SIZE(((int *)(bp) - DSIZE))) //line:vm:mm:prevblkp
/* $end mallocmacros */
